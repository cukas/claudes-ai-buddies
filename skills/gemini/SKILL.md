...
5. **Show Gemini's raw response directly.** Use this format — show their actual words, don't paraphrase or summarize:
...
6. **Add your own take only if asked.** If the user wants a comparison or synthesis, add it after Gemini's response. Otherwise, let Gemini's voice stand on its own.
